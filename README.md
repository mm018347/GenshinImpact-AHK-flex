...
С игры кикает каждые 5-10 мин у меня и у друга, античит подняли с колен? Чистил реестр, проверял файлы игры, подрубал ВПН не помогает. Если скрипт просто запущен то все ок. Клиентский античит вроде не душит, но если стреляю на Еимии - Эмбер с пулемета то кик с сервера "Ошибка данных. Пожалуйста повторите вход в игру". Сижу разгадываю ребусы...
